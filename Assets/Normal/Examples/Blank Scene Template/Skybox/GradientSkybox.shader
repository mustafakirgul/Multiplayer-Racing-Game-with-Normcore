Shader "Normal/Examples/Gradient Skybox"
{
    ...
    SubShader
    {
        Tags
        {
            "RenderType"="Background" "Queue"="Background" "DisableBatching"="True" "IgnoreProjector"="True" "PreviewType"="Skybox"
        }
        Fog
        {
            Mode Off
        ...
        Pass
        {
            ...
            fixed4 frag(Varyings i) : SV_Target
            {
                ...
                #if SUN
                color += min(pow(max(0, dot(n, _SunVector)), pow(50000.0, 1.0 - _SunSize)), 1) * _SunColor *
                    _SunIntensity;
                #endif
