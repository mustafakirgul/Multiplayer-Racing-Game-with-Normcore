...
half4 bakeryFragForwardBase(BakeryVertexOutputForwardBase i) : SV_Target
{
    ...
    gi.indirect.diffuse.r = shEvaluateDiffuseL1Geomerics(L0.r, float3(L1x.r, L1y.r, L1z.r), s.normalWorld);
    gi.indirect.diffuse.g = shEvaluateDiffuseL1Geomerics(L0.g, float3(L1x.g, L1y.g, L1z.g), s.normalWorld);
    gi.indirect.diffuse.b = shEvaluateDiffuseL1Geomerics(L0.b, float3(L1x.b, L1y.b, L1z.b), s.normalWorld);
        ...
        float3 nL1z = L1z / L0;
        float3 dominantDir = float3(dot(nL1x, lumaConv), dot(nL1y, lumaConv), dot(nL1z, lumaConv));
        half3 halfDir = Unity_SafeNormalize(normalize(dominantDir) - s.eyeVec);
