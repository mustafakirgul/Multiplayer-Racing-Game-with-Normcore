...
public class CarSoundManager : MonoBehaviour
{
    ...
    private WC_Car_Controller m_CarController; // Reference to car we are controlling
    [SerializeField]
    float currentRPM;
    ...
    private void Start()
    {
        // get the carcontroller
        m_CarController = GetComponent<WC_Car_Controller>();
    }
    ...
    private void Update()
    {
        currentRPM = Mathf.Abs(m_CarController.RPM / m_CarController.maxTheoreticalRPM);
        ...
        if (m_StartedSound)
        {
            ...
            float pitch = ULerp(lowPitchMin, lowPitchMax, currentRPM);
            ...
            else
            {
                ...
                float highFade = Mathf.InverseLerp(0.2f, 0.8f, currentRPM);
