...
public partial class LobbiestModel
{
    ...
    [RealtimeProperty(4, true, true)] private bool _isHost;
}
...
public partial class LobbiestModel : RealtimeModel
{
    ...
    {
        get { return _cache.LookForValueInCache(_roomName, entry => entry.roomNameSet, entry => entry.roomName); }
        set
        {
            if (this.roomName == value) return;
            _cache.UpdateLocalCache(entry =>
            {
                entry.roomNameSet = true;
                entry.roomName = value;
                return entry;
            });
    ...
    {
        get { return _cache.LookForValueInCache(_maxPlayers, entry => entry.maxPlayersSet, entry => entry.maxPlayers); }
        set
        {
            if (this.maxPlayers == value) return;
            _cache.UpdateLocalCache(entry =>
            {
                entry.maxPlayersSet = true;
                entry.maxPlayers = value;
                return entry;
            });
            InvalidateReliableLength();
    ...
    public bool isHost
    {
        get { return _cache.LookForValueInCache(_isHost, entry => entry.isHostSet, entry => entry.isHost); }
        set
        {
            if (this.isHost == value) return;
            _cache.UpdateLocalCache(entry =>
            {
                entry.isHostSet = true;
                entry.isHost = value;
                return entry;
            });
            InvalidateReliableLength();
    ...
    protected override void Write(WriteStream stream, StreamContext context)
    {
        ...
        {
            LocalCacheEntry entry = _cache.localCache;
            if (entry.roomNameSet || entry.maxPlayersSet || entry.isReadySet || entry.isHostSet)
            {
