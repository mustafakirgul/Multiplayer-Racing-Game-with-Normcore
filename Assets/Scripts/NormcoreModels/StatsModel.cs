...
public partial class StatsModel
{
    ...
    [RealtimeProperty(5, true, false)] private int _killer;
}
...
public partial class StatsModel : RealtimeModel {
    ...
    public int killer {
        get {
            return _cache.LookForValueInCache(_killer, entry => entry.killerSet, entry => entry.killer);
        }
        set {
            if (this.killer == value) return;
            _cache.UpdateLocalCache(entry => { entry.killerSet = true; entry.killer = value; return entry; });
            InvalidateReliableLength();
        }
    }
    ...
    protected override int WriteLength(StreamContext context) {
        ...
        if (context.fullModel) {
            ...
            length += WriteStream.WriteVarint32Length((uint)PropertyID.Killer, (uint)_killer);
            ...
            if (entry.killerSet) {
                length += WriteStream.WriteVarint32Length((uint)PropertyID.Killer, (uint)entry.killer);
            }
        }
        return length;
    }
    ...
    protected override void Write(WriteStream stream, StreamContext context) {
        ...
        if (context.fullModel) {
            ...
            stream.WriteVarint32((uint)PropertyID.Killer, (uint)_killer);
        } else if (context.reliableChannel) {
            LocalCacheEntry entry = _cache.localCache;
            if (entry.killsSet || entry.damageToTruckSet || entry.powerUpSet || entry.lootSet || entry.killerSet) {
            ...
            if (entry.killerSet) {
                stream.WriteVarint32((uint)PropertyID.Killer, (uint)entry.killer);
                didWriteProperties = true;
            }
    ...
    protected override void Read(ReadStream stream, StreamContext context) {
        while (stream.ReadNextPropertyID(out uint propertyID)) {
            switch (propertyID) {
                ...
                case (uint)PropertyID.Killer: {
                    _killer = (int)stream.ReadVarint32();
                    break;
                }
                default: {
                    stream.SkipProperty();
