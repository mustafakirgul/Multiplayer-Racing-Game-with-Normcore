...
public partial class RaceModel : RealtimeModel
{
    public double gameStartTime
    {
        get
        {
            return _cache.LookForValueInCache(_gameStartTime, entry => entry.gameStartTimeSet,
                entry => entry.gameStartTime);
        }
        set
        {
            ...
            {
                entry.gameStartTimeSet = true;
                entry.gameStartTime = value;
                return entry;
            });
    ...
    public int phase
    {
        get { return _cache.LookForValueInCache(_phase, entry => entry.phaseSet, entry => entry.phase); }
        set
        {
    ...
    public bool isOn
    {
        get { return _cache.LookForValueInCache(_isOn, entry => entry.isOnSet, entry => entry.isOn); }
        set
        {
