    ...
    public class BeautifyRendererFeature : ScriptableRendererFeature {
        ...
        class BeautifyRenderPass : ScriptableRenderPass {
            ...
            static class ShaderParams {
                ...
                public static int sfOcclusionDepth;
                ...
                static ShaderParams() {
                    ...
                    bloomNearThreshold = Shader.PropertyToID("_BloomNearThreshold");
                    ...
                    afNearThreshold = Shader.PropertyToID("_AFNearThreshold");
                    ...
                    sfOcclusionDepth = Shader.PropertyToID("_SunOcclusionDepth");
                    ...
                    vignetteData = Shader.PropertyToID("_VignettingData");
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData) {
                ...
                if (beautify.directWrite.value) {
                    ...
                    if (beautify.blurIntensity.value > 0) {
                        ApplyFinalBlur(cmd);

                        if (beautify.compareMode.value) {
                            cmd.GetTemporaryRT(ShaderParams.compareTex, sourceDesc, FilterMode.Point);
                            FullScreenBlit(cmd, ShaderParams.blurRT, ShaderParams.compareTex, bMat, (int)Pass.Beautify);
                            ...
                            FullScreenBlit(cmd, ShaderParams.blurRT, BuiltinRenderTextureType.CameraTarget, bMat, (int)Pass.Beautify);
                        }
                        ...
                        FullScreenBlit(cmd, source, BuiltinRenderTextureType.CameraTarget, bMat, (int)Pass.Beautify);
                    }
                    ...
                    if (beautify.debugOutput.value == Beautify.DebugOutput.DepthOfFieldCoC) {
                        ...
                        if (beautify.compareMode.value) {
                            ...
                            FullScreenBlit(cmd, ShaderParams.blurRT, source, bMat, (int)Pass.Beautify);
                        }
                    } else if (beautify.compareMode.value) {
                        cmd.GetTemporaryRT(ShaderParams.compareTex, sourceDesc, FilterMode.Point);
                        FullScreenBlit(cmd, source, ShaderParams.compareTex, bMat, (int)Pass.Beautify);
            ...
            void DoDoF(CommandBuffer cmd) {
                ...
                BeautifySettings.dofTransparentSupport = beautify.depthOfFieldTransparentSupport.value;
            ...
            void UpdateMaterialProperties() {
                ...
                if (beautify.optimizeBuildBeautifyAuto.value || !beautify.stripBeautifyBloom.value) {
                    ...
                    if (sunFlareEnabled) {
                        ...
                        bMat.SetFloat(ShaderParams.sfOcclusionDepth, beautify.sunFlaresUseLayerMask.value ? 0: 1);
                        if (flareTex == null) {
                ...
                if (beautify.depthOfField.value && (beautify.optimizeBuildBeautifyAuto.value || !beautify.stripBeautifyDoF.value)) {
                    ...
                    if (beautify.depthOfFieldTransparentSupport.value && beautify.depthOfFieldTransparentLayerMask.value > 0 && (beautify.optimizeBuildBeautifyAuto.value || !beautify.stripBeautifyDoFTransparentSupport.value)) {
        ...
        class BeautifyDoFTransparentMaskPass : ScriptableRenderPass {
            ...
            public BeautifyDoFTransparentMaskPass() {
                m_Depth.Init(dofTransparentDepthRT);
                renderPassEvent = RenderPassEvent.AfterRenderingOpaques;
                m_ShaderTagIdList.Add(new ShaderTagId("SRPDefaultUnlit"));
                m_ShaderTagIdList.Add(new ShaderTagId("UniversalForward"));
                m_ShaderTagIdList.Add(new ShaderTagId("LightweightForward"));
            ...
            public override void Configure(CommandBuffer cmd, RenderTextureDescriptor cameraTextureDescriptor) {
                ...
                depthDesc.msaaSamples = 1;
                cmd.GetTemporaryRT(m_Depth.id, depthDesc, FilterMode.Point);
                cmd.SetGlobalTexture(dofTransparentDepthRT, m_Depth.Identifier());
                ConfigureTarget(m_Depth.Identifier());
                ConfigureClear(ClearFlag.All, Color.black);
            }
