...
namespace Vectrosity
{
    ...
    public class VisibilityControl : MonoBehaviour
    {
        ...
        {
            // Since Renderer.isVisible doesn't work in Setup and needs to wait a couple frames
            yield return null;
            yield return null;
        ...
        {
            yield return
                new WaitForEndOfFrame(); // Since otherwise Unity 5.6 can't enable/disable renderers during OnBecameVisible
