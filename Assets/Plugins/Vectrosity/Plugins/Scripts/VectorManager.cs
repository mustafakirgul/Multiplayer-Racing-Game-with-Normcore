...
namespace Vectrosity
{
    public class VectorManager
    {
        ...
        public static void SetBrightnessParameters(float fadeOutDistance, float fullBrightDistance, int levels,
            float frequency, Color color)
        {
        ...
        public static float GetBrightnessValue(Vector3 pos)
        {
            ...
            return Mathf.InverseLerp(minBrightnessDistance, maxBrightnessDistance,
                (pos - VectorLine.camTransformPosition).sqrMagnitude);
        }
